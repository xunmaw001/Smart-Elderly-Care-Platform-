        ...
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
                ...
                <div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="机构社区人员" onclick="checkRole('jigoushequ')">&nbsp;机构社区人员
                        </label>
                    </div>
                </div>
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="家人" onclick="checkRole('jiaren')">&nbsp;家人
                        </label>
                    </div>
                </div>
                <div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="老人" onclick="checkRole('laoren')">&nbsp;老人
                        </label>
                    </div>
                </div>
                <div id="submitBtn" class="form-group"><button type="submit" class="btn btn-success" style="width: 100%;" onclick="login()">登 录</button></div>
				<%--<div class="form-group"><button type="button" class="btn btn-success" style="width: 100%;" onclick="window.location.href='./modules/laoren/register.jsp'">注册  老人</button></div>--%>
				<%--<div class="form-group"><button type="button" class="btn btn-success" style="width: 100%;" onclick="window.location.href='./modules/jigoushequ/register.jsp'">注册  机构社区人员</button></div>--%>
				<%--<div class="form-group"><button type="button" class="btn btn-success" style="width: 100%;" onclick="window.location.href='./modules/jiaren/register.jsp'">注册  家人</button></div>--%>
