            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">家人登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="laorenId" name="laorenId" v-model="ruleForm.laorenId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jiarenName" name="jiarenName" class="form-control"
                                               v-model="ruleForm.jiarenName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jiarenPhone" name="jiarenPhone" class="form-control"
                                               v-model="ruleForm.jiarenPhone" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jiarenIdNumber" name="jiarenIdNumber" class="form-control"
                                               v-model="ruleForm.jiarenIdNumber" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>照片</label>
                                    <img id="jiarenPhotoImg" width="100" height="100">
                                </div>
