            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">求助服务登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="laorenId" name="laorenId" v-model="ruleForm.laorenId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="qiuzhuName" name="qiuzhuName" class="form-control"
                                               v-model="ruleForm.qiuzhuName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>求助类型</label>
                                    <input id="qiuzhuValue" name="qiuzhuValue" class="form-control"
                                           v-model="ruleForm.qiuzhuValue" readonly>
                                </div>


                                    <div class="form-group col-md-6">
                                        <label>执行时间</label>
                                        <input id="zhixingTime" name="zhixingTime" class="form-control"
                                               v-model="ruleForm.zhixingTime" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>是否处理</label>
                                    <input id="qiuzhuYesnoValue" name="qiuzhuYesnoValue" class="form-control"
                                           v-model="ruleForm.qiuzhuYesnoValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.qiuzhuContent != null && ruleForm.qiuzhuContent != 'null' && ruleForm.qiuzhuContent != '') {
            var qiuzhuContentUeditor = UE.getEditor('qiuzhuContentEditor');
                qiuzhuContentUeditor.ready(function () {
                    var mes = '' + ruleForm.qiuzhuContent;
                    qiuzhuContentUeditor.setContent(mes);
                    qiuzhuContentUeditor.setDisabled('fullscreen');
            });
        }
    }
