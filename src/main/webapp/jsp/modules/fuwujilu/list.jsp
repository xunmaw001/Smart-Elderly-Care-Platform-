...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">服务记录管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">服务记录列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">服务记录列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="fuwujiluTypesSelectSearch"  style="width: 150px;" id="fuwujiluTypesSelectSearch" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        姓名
                                        <div class="layui-input-inline">
                                            <input type="text" id="jigoushequNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        手机号
                                        <div class="layui-input-inline">
                                            <input type="text" id="jigoushequPhoneSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        身份证号
                                        <div class="layui-input-inline">
                                            <input type="text" id="jigoushequIdNumberSearch" style="width: 140px;" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
                            ...
                            //姓名
            var jigoushequNameSearchInput = $('#jigoushequNameSearch');
            if( jigoushequNameSearchInput != null){
                if (jigoushequNameSearchInput.val() != null && jigoushequNameSearchInput.val() != '') {
                    searchForm.jigoushequName = $('#jigoushequNameSearch').val();
                }
            }
                     
                            //手机号
            var jigoushequPhoneSearchInput = $('#jigoushequPhoneSearch');
            if( jigoushequPhoneSearchInput != null){
                if (jigoushequPhoneSearchInput.val() != null && jigoushequPhoneSearchInput.val() != '') {
                    searchForm.jigoushequPhone = $('#jigoushequPhoneSearch').val();
                }
            }
                     
                            //身份证号
            var jigoushequIdNumberSearchInput = $('#jigoushequIdNumberSearch');
            if( jigoushequIdNumberSearchInput != null){
                if (jigoushequIdNumberSearchInput.val() != null && jigoushequIdNumberSearchInput.val() != '') {
                    searchForm.jigoushequIdNumber = $('#jigoushequIdNumberSearch').val();
                }
            }
            ...
            if(yanglaofanghsiTypesSelectSearchInput != null){
                ...
                //评价星级类型
            var fuwujiluTypesSelectSearchInput = document.getElementById("fuwujiluTypesSelectSearch");
            if(fuwujiluTypesSelectSearchInput != null){
                var fuwujiluTypesIndex = fuwujiluTypesSelectSearchInput.selectedIndex;
                if( fuwujiluTypesIndex  != 0){
                    searchForm.fuwujiluTypes= document.getElementById("fuwujiluTypesSelectSearch").options[fuwujiluTypesIndex].value;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("fuwujilu/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                fuwujiluTypes: searchForm.fuwujiluTypes,
            //级联表的
                jigoushequName: searchForm.jigoushequName,
                jigoushequPhone: searchForm.jigoushequPhone,
                jigoushequIdNumber: searchForm.jigoushequIdNumber,
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(checkbox)
                    ...
                    //姓名
            var jigoushequNameCell = document.createElement('td');
            jigoushequNameCell.innerHTML = item.jigoushequName;
            row.appendChild(jigoushequNameCell);


                    //手机号
            var jigoushequPhoneCell = document.createElement('td');
            jigoushequPhoneCell.innerHTML = item.jigoushequPhone;
            row.appendChild(jigoushequPhoneCell);


                    //身份证号
            var jigoushequIdNumberCell = document.createElement('td');
            jigoushequIdNumberCell.innerHTML = item.jigoushequIdNumber;
            row.appendChild(jigoushequIdNumberCell);


                //照片
            var jigoushequPhotoCell = document.createElement('td');
            var jigoushequPhotoImg = document.createElement('img');
            var jigoushequPhotoImgValue = item.jigoushequPhoto;
            if(jigoushequPhotoImgValue !=null && jigoushequPhotoImgValue !='' && jigoushequPhotoImgValue !='null'){
                    jigoushequPhotoImg.setAttribute('src', jigoushequPhotoImgValue);
                    jigoushequPhotoImg.setAttribute('height', 100);
                    jigoushequPhotoImg.setAttribute('width', 100);
                    jigoushequPhotoCell.appendChild(jigoushequPhotoImg);
            }else{
                    jigoushequPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(jigoushequPhotoCell);
            ...
            row.appendChild(insertTimeCell);
                ...
                //服务详情
            var fuwujiluContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.fuwujiluContent && item.fuwujiluContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.fuwujiluContent.indexOf('<img');
                var endIndex = item.fuwujiluContent.indexOf('>');
                    fuwujiluContentCell.innerHTML = item.fuwujiluContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.fuwujiluContent != null && item.fuwujiluContent != "" && item.fuwujiluContent.length >= 11) {
                        fuwujiluContentCell.innerHTML = item.fuwujiluContent.substring(0, 10) + "...";
                } else {
                        fuwujiluContentCell.innerHTML = item.fuwujiluContent;
                }
            }
            row.appendChild(fuwujiluContentCell);


            //评价星级类型
            var fuwujiluTypesCell = document.createElement('td');
            fuwujiluTypesCell.innerHTML = item.fuwujiluValue;
            row.appendChild(fuwujiluTypesCell);


                //评价详情
            var pingjiaContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.pingjiaContent && item.pingjiaContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.pingjiaContent.indexOf('<img');
                var endIndex = item.pingjiaContent.indexOf('>');
                    pingjiaContentCell.innerHTML = item.pingjiaContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.pingjiaContent != null && item.pingjiaContent != "" && item.pingjiaContent.length >= 11) {
                        pingjiaContentCell.innerHTML = item.pingjiaContent.substring(0, 10) + "...";
                } else {
                        pingjiaContentCell.innerHTML = item.pingjiaContent;
                }
            }
            row.appendChild(pingjiaContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("fuwujilu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addfuwujilu", "addfuwujilu");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function fuwujiluTypesSelectSearch() {
            var fuwujiluTypesSelectSearch = document.getElementById('fuwujiluTypesSelectSearch');
            if(fuwujiluTypesSelectSearch != null) {
                fuwujiluTypesSelectSearch.add(new Option('-请选择-',''));
                if (fuwujiluTypesOptions != null && fuwujiluTypesOptions.length > 0){
                    for (var i = 0; i < fuwujiluTypesOptions.length; i++) {
                            fuwujiluTypesSelectSearch.add(new Option(fuwujiluTypesOptions[i].indexName,fuwujiluTypesOptions[i].codeIndex));
                    }
                }
            }
        }
