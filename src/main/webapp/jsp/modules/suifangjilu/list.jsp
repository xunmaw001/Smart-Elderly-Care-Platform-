        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">随访记录管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">随访记录管理</li>
                            <li class="breadcrumb-item active">随访记录列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">随访记录列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(insertTimeCell);
                ...
                //随访详情
            var suifangjiluContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.suifangjiluContent && item.suifangjiluContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.suifangjiluContent.indexOf('<img');
                var endIndex = item.suifangjiluContent.indexOf('>');
                    suifangjiluContentCell.innerHTML = item.suifangjiluContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.suifangjiluContent != null && item.suifangjiluContent != "" && item.suifangjiluContent.length >= 11) {
                        suifangjiluContentCell.innerHTML = item.suifangjiluContent.substring(0, 10) + "...";
                } else {
                        suifangjiluContentCell.innerHTML = item.suifangjiluContent;
                }
            }
            row.appendChild(suifangjiluContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("suifangjilu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addsuifangjilu", "addsuifangjilu");
            window.location.href = "add-or-update.jsp"
        }
