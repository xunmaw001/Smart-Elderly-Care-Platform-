            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">随访记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "suifangjilu/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.suifangjiluContent != null && ruleForm.suifangjiluContent != 'null' && ruleForm.suifangjiluContent != '') {
            var suifangjiluContentUeditor = UE.getEditor('suifangjiluContentEditor');
                suifangjiluContentUeditor.ready(function () {
                    var mes = '' + ruleForm.suifangjiluContent;
                    suifangjiluContentUeditor.setContent(mes);
                    suifangjiluContentUeditor.setDisabled('fullscreen');
            });
        }
    }
