...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">就诊记录管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">就诊记录列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">就诊记录列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="jiuzhenjiluTypesSelectSearch"  style="width: 150px;" id="jiuzhenjiluTypesSelectSearch" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        就诊医院
                                        <div class="layui-input-inline">
                                            <input type="text" id="yiyuanSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="就诊医院" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        就诊医生
                                        <div class="layui-input-inline">
                                            <input type="text" id="yishengSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="就诊医生" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if(yanglaofanghsiTypesSelectSearchInput != null){
                ...
                //就诊类型
            var jiuzhenjiluTypesSelectSearchInput = document.getElementById("jiuzhenjiluTypesSelectSearch");
            if(jiuzhenjiluTypesSelectSearchInput != null){
                var jiuzhenjiluTypesIndex = jiuzhenjiluTypesSelectSearchInput.selectedIndex;
                if( jiuzhenjiluTypesIndex  != 0){
                    searchForm.jiuzhenjiluTypes= document.getElementById("jiuzhenjiluTypesSelectSearch").options[jiuzhenjiluTypesIndex].value;
                }
            }
     
            //就诊医院
            var yiyuanSearchInput = $('#yiyuanSearch');
            if( yiyuanSearchInput != null){
                if (yiyuanSearchInput.val() != null && yiyuanSearchInput.val() != '') {
                    searchForm.yiyuan = $('#yiyuanSearch').val();
                }
            }
     
            //就诊医生
            var yishengSearchInput = $('#yishengSearch');
            if( yishengSearchInput != null){
                if (yishengSearchInput.val() != null && yishengSearchInput.val() != '') {
                    searchForm.yisheng = $('#yishengSearch').val();
                }
            }
        ...
        function getDataList() {
            http("jiuzhenjilu/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                jiuzhenjiluTypes: searchForm.jiuzhenjiluTypes,
                yiyuan: searchForm.yiyuan,
                yisheng: searchForm.yisheng,
        ...
        function setDataRow(item, number) {
            ...
            //就诊类型
            var jiuzhenjiluTypesCell = document.createElement('td');
            jiuzhenjiluTypesCell.innerHTML = item.jiuzhenjiluValue;
            row.appendChild(jiuzhenjiluTypesCell);
            ...
            //就诊医生
            var yishengCell = document.createElement('td');
            yishengCell.innerHTML = item.yisheng;
            row.appendChild(yishengCell);
            ...
            row.appendChild(insertTimeCell);
                ...
                //就诊详情
            var jiuzhenjiluContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.jiuzhenjiluContent && item.jiuzhenjiluContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.jiuzhenjiluContent.indexOf('<img');
                var endIndex = item.jiuzhenjiluContent.indexOf('>');
                    jiuzhenjiluContentCell.innerHTML = item.jiuzhenjiluContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.jiuzhenjiluContent != null && item.jiuzhenjiluContent != "" && item.jiuzhenjiluContent.length >= 11) {
                        jiuzhenjiluContentCell.innerHTML = item.jiuzhenjiluContent.substring(0, 10) + "...";
                } else {
                        jiuzhenjiluContentCell.innerHTML = item.jiuzhenjiluContent;
                }
            }
            row.appendChild(jiuzhenjiluContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jiuzhenjilu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjiuzhenjilu", "addjiuzhenjilu");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function jiuzhenjiluTypesSelectSearch() {
            var jiuzhenjiluTypesSelectSearch = document.getElementById('jiuzhenjiluTypesSelectSearch');
            if(jiuzhenjiluTypesSelectSearch != null) {
                jiuzhenjiluTypesSelectSearch.add(new Option('-请选择-',''));
                if (jiuzhenjiluTypesOptions != null && jiuzhenjiluTypesOptions.length > 0){
                    for (var i = 0; i < jiuzhenjiluTypesOptions.length; i++) {
                            jiuzhenjiluTypesSelectSearch.add(new Option(jiuzhenjiluTypesOptions[i].indexName,jiuzhenjiluTypesOptions[i].codeIndex));
                    }
                }
            }
        }
