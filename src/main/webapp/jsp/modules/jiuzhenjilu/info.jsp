            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">就诊记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>就诊类型</label>
                                    <input id="jiuzhenjiluValue" name="jiuzhenjiluValue" class="form-control"
                                           v-model="ruleForm.jiuzhenjiluValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="yisheng" name="yisheng" class="form-control"
                                               v-model="ruleForm.yisheng" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jiuzhenjilu/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.jiuzhenjiluContent != null && ruleForm.jiuzhenjiluContent != 'null' && ruleForm.jiuzhenjiluContent != '') {
            var jiuzhenjiluContentUeditor = UE.getEditor('jiuzhenjiluContentEditor');
                jiuzhenjiluContentUeditor.ready(function () {
                    var mes = '' + ruleForm.jiuzhenjiluContent;
                    jiuzhenjiluContentUeditor.setContent(mes);
                    jiuzhenjiluContentUeditor.setDisabled('fullscreen');
            });
        }
    }
