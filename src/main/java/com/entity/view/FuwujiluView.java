...
public class FuwujiluView extends FuwujiluEntity implements Serializable {
	...
	public FuwujiluView(FuwujiluEntity fuwujiluEntity) {
		try {
			...
			* 获取： 评价星级类型的值
			*/
			public String getFuwujiluValue() {
				return fuwujiluValue;
			}
			/**
			* 设置： 评价星级类型的值
			*/
			public void setFuwujiluValue(String fuwujiluValue) {
				this.fuwujiluValue = fuwujiluValue;
			}
