...
public class JiuzhenjiluView extends JiuzhenjiluEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 就诊类型的值
		*/
		private String jiuzhenjiluValue;
	...
	public JiuzhenjiluView(JiuzhenjiluEntity jiuzhenjiluEntity) {
		try {
			...
			* 获取： 就诊类型的值
			*/
			public String getJiuzhenjiluValue() {
				return jiuzhenjiluValue;
			}
			/**
			* 设置： 就诊类型的值
			*/
			public void setJiuzhenjiluValue(String jiuzhenjiluValue) {
				this.jiuzhenjiluValue = jiuzhenjiluValue;
			}
