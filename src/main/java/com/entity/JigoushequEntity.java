...
public class JigoushequEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JigoushequEntity() {

	}

	public JigoushequEntity(T t) {
		try {
     ...
     * 姓名
     */
    @TableField(value = "jigoushequ_name")
     ...
     * 手机号
     */
    @TableField(value = "jigoushequ_phone")
     ...
     * 身份证号
     */
    @TableField(value = "jigoushequ_id_number")
     ...
     * 照片
     */
    @TableField(value = "jigoushequ_photo")
    ...
    public String toString() {
        return "Jigoushequ{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", jigoushequName=" + jigoushequName +
            ", jigoushequPhone=" + jigoushequPhone +
            ", jigoushequIdNumber=" + jigoushequIdNumber +
            ", jigoushequPhoto=" + jigoushequPhoto +
            ", sexTypes=" + sexTypes +
